...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_addressbook_2eproto = nullptr;
...
const ::uint32_t
    TableStruct_addressbook_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        1,
        ~0u,
        PROTOBUF_FIELD_OFFSET(::tutorial::PhoneNumber, _impl_._has_bits_),
        ...
        PROTOBUF_FIELD_OFFSET(::tutorial::PhoneNumber, _impl_.type_),
        0,
        1,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {16, 26, -1, sizeof(::tutorial::PhoneNumber)},
};
...
const char descriptor_table_protodef_addressbook_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\021addressbook.proto\022\010tutorial\"X\n\006Person\022"
    "\014\n\004name\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005email\030\003 \001(\t"
    "\022%\n\006phones\030\004 \003(\0132\025.tutorial.PhoneNumber\""
...
PROTOBUF_NDEBUG_INLINE Person::Impl_::Impl_(
    ...
    const ::tutorial::Person& from_msg)
...
Person::_table_ = {
  ...
  {{
      {::_pbi::TcParser::GetTable<::tutorial::PhoneNumber>()},
  }},
  {{
    "\17\4\0\5\0\0\0\0"
    "tutorial.Person"
...
PROTOBUF_NDEBUG_INLINE PhoneNumber::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::tutorial::PhoneNumber& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL PhoneNumber::GetClassData() const {
...
PhoneNumber::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::tutorial::PhoneNumber>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // int32 type = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(PhoneNumber, _impl_.type_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(PhoneNumber, _impl_.type_)}},
    // string number = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(PhoneNumber, _impl_.number_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string number = 1;
    {PROTOBUF_FIELD_OFFSET(PhoneNumber, _impl_.number_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 type = 2;
    {PROTOBUF_FIELD_OFFSET(PhoneNumber, _impl_.type_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
    "\24\6\0\0\0\0\0\0"
    "tutorial.PhoneNumber"
    "number"
  }},
};
...
::uint8_t* PROTOBUF_NONNULL PhoneNumber::_InternalSerialize(
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_number().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "tutorial.PhoneNumber.number");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
