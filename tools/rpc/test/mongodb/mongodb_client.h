...
public:
  ...
  /* 插入消息 */
  bool insertMessage(const std::string& user, const std::string& sessionID,
                     const std::string& from, const std::string& content);

  bool insertSession(const std::string& user, const std::string& sessionID);

  /* 查询消息 */
  std::vector<bsoncxx::document::value> queryMessages(const std::string& user,
