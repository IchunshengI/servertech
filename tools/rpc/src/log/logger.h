...
public:
    ...
    Logger(boost::asio::any_io_executor io_context, size_t time, std::string file_path, size_t file_size, size_t default_buffer_size = 8192);
...
private:
    ...
    /* 后端写入组件 */
    boost::asio::any_io_executor io_context_;   /* 日志系统中异步操作使用的上下文 */
